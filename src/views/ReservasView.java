...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 236, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 221, 236, 14);
		...
		lblTitulo.setBounds(97, 60, 236, 42);
		...
		JLabel lblbtnSiguiente = new JLabel("Continuar");
		lblbtnSiguiente.setHorizontalAlignment(SwingConstants.CENTER);
		lblbtnSiguiente.setFont(new Font("Dialog", Font.BOLD, 16));
		lblbtnSiguiente.setForeground(new Color(255, 255, 255));
		lblbtnSiguiente.setBounds(5, 5, 112, 25);
		btnsiguiente.add(lblbtnSiguiente);
	}
